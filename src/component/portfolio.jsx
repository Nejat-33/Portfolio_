...
const SKILLS = {
  Backend: [
    { name: "Node.JS",      level: 85, tag: "JavaScript" },
      ...
      <div style={{
        ...
        <div style={{ flex: "1 1 420px" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
            ...
            <a href="/Portfolio_/Nejat_Ebrahim_Resume%20(2).pdf"
              target="_blank"
...
function Contact() {
  ...
  const CONTACTS = [
    ...
    { label: "LinkedIn", val: "https://www.linkedin.com/in/nejat-ebrahim-14b5a1320/",  href: "https://www.linkedin.com/in/nejat-ebrahim-14b5a1320/",
